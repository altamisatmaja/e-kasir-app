...
/// [EKasirApp] uses this [TextStyle] as its [DefaultTextStyle] to encourage
...
/// Describes which theme will be used by [EKasirApp].
enum ThemeMode {
...
/// [GridPaper].
///
/// [EKasirApp] configures its [WidgetsApp.textStyle] with an ugly red/yellow
...
///
/// The [EKasirApp] configures the top-level [Navigator] to search for routes
...
///
/// {@template flutter.material.EKasirApp.defaultSelectionStyle}
/// The [EKasirApp] automatically creates a [DefaultSelectionStyle]. It uses
/// the colors in the [ThemeData.textSelectionTheme] if they are not null;
/// otherwise, the [EKasirApp] sets [DefaultSelectionStyle.selectionColor] to
...
///
/// {@tool snippet}
/// This example shows how to create a [EKasirApp] that disables the "debug"
/// banner with a [home] route that will be displayed when the app is launched.
///
/// ![The EKasirApp displays a Scaffold ](https://flutter.github.io/assets-for-api-docs/assets/material/basic_material_app.png)
///
/// ```dart
/// EKasirApp(
///   home: Scaffold(
...
///
/// {@tool snippet}
/// This example shows how to create a [EKasirApp] that uses the [routes]
...
///
/// {@tool snippet}
/// This example shows how to create a [EKasirApp] that defines a [theme] that
/// will be used for material widgets in the app.
///
/// ![The EKasirApp displays a Scaffold with a dark background and a blue / grey AppBar at the top](https://flutter.github.io/assets-for-api-docs/assets/material/theme_material_app.png)
///
/// ```dart
/// EKasirApp(
///   theme: ThemeData(
...
///   home: Scaffold(
///     appBar: AppBar(
///       title: const Text('EKasirApp Theme'),
///     ),
///   ),
/// )
/// ```
...
class EKasirApp extends StatefulWidget {
  /// Creates a EKasirApp.
  ///
  ...
  const EKasirApp({
    ...
    @Deprecated(
      ...
      'EKasirApp never introduces its own MediaQuery; the View widget takes care of that. '
  ...
  /// Creates a [EKasirApp] that uses the [Router] instead of a [Navigator].
  ///
  /// {@macro flutter.widgets.WidgetsApp.router}
  const EKasirApp.router({
    super.key,
    this.scaffoldMessengerKey,
  ...
  /// ```
  ///
  /// Constructing a [EKasirApp] with a `FooLocalizationsDelegate` overrides
  ...
  /// {@template flutter.material.EKasirApp.scrollBehavior}
  ...
  /// duration in the [EKasirApp] widget using [AnimationStyle].
  ///
  ...
  @override
  State<EKasirApp> createState() => _EKasirAppState();

  /// The [HeroController] used for Material page transitions.
  ///
  /// Used by the [EKasirApp].
...
/// Describes how [Scrollable] widgets behave for [EKasirApp]s.
///
...
class _EKasirAppState extends State<EKasirApp> {
  ...
  void initState() {
    super.initState();
    _heroController = EKasirApp.createMaterialHeroController();
  }
